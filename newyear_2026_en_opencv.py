...
"""
Happy New Year 2026 with Squares, Snowflakes, Tree with Ornaments & Gifts!
...
# TEXTS
cv2.putText(image, "HAPPY NEW YEAR!", (95,135), FONT, 2, (0,205,255), 3, AA)
...
cv2.imshow("HAPPY NEW YEAR 2026", image)
k = cv2.waitKey(0) & 0xFF
if k == ord('s'):
    print("Saving image...")
    cv2.imwrite("newyear_2026_en.png", image)
